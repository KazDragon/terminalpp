...
// CONSTRUCTOR
// ==========================================================================
string::string(char const *text) : string(text, strlen(text))
{
}
...
// CONSTRUCTOR
// ==========================================================================
string::string(char const *text, size_type len) : elements_(text, text + len)
{
}
...
// CONSTRUCTOR
// ==========================================================================
string::string(std::string const &text) : string(text.c_str(), text.size())
{
}
...
// CONSTRUCTOR
// ==========================================================================
string::string(size_type size, element const &elem) : elements_(size, elem)
{
}
