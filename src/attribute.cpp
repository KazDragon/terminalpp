...
std::ostream &operator<<(std::ostream &out, attribute const &attr)
{
    ...
    output_non_default_attribute(out, attr.foreground_colour_, with_comma, "foreground[", "]");
    output_non_default_attribute(out, attr.background_colour_, with_comma, "background[", "]");
