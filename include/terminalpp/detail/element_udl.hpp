...
{
  constexpr std::uint64_t const maxima[] = {
      0x00007F, 0x0007FF, 0x00FFFF, 0x10FFFF};
...
constexpr void parse_bg_true_colour_3(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_true_colour_2(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_true_colour_1(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_true_colour_0(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_greyscale_1(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_greyscale_0(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_high_colour_2(
    char const ch, parser_info &info, element &elem)
{
  auto const blue = digit10_to_byte(ch);
  elem.attribute_.background_colour_ = high_colour(info.red, info.green, blue);
  info.state = parser_state::idle;
}

constexpr void parse_bg_high_colour_1(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_high_colour_0(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_bg_low_colour(
    char const ch, parser_info &info, element &elem)
{
...
constexpr void parse_fg_greyscale_1(
    char const ch, parser_info &info, element &elem)
{
  byte const col = (info.greyscale * 10) + digit10_to_byte(ch);
...
constexpr void parse_fg_greyscale_0(
    char const ch, parser_info &info, element &elem)
{
  info.greyscale = digit10_to_byte(ch);
...
constexpr void parse_fg_true_colour_5(
    char const ch, parser_info &info, element &elem)
{
  info.blue |= digit16_to_byte(ch);
...
constexpr void parse_fg_true_colour_4(
    char const ch, parser_info &info, element &elem)
{
  info.blue = digit16_to_byte(ch) << 4;
...
constexpr void parse_fg_true_colour_3(
    char const ch, parser_info &info, element &elem)
{
  info.green |= digit16_to_byte(ch);
...
constexpr void parse_fg_true_colour_2(
    char const ch, parser_info &info, element &elem)
{
  info.green = digit16_to_byte(ch) << 4;
...
constexpr void parse_fg_true_colour_1(
    char const ch, parser_info &info, element &elem)
{
  info.red |= digit16_to_byte(ch);
...
constexpr void parse_fg_true_colour_0(
    char const ch, parser_info &info, element &elem)
{
  info.red = digit16_to_byte(ch) << 4;
...
constexpr void parse_fg_high_colour_2(
    char const ch, parser_info &info, element &elem)
{
  auto const blue = digit10_to_byte(ch);
  elem.attribute_.foreground_colour_ = high_colour(info.red, info.green, blue);
  info.state = parser_state::idle;
}

constexpr void parse_fg_high_colour_1(
    char const ch, parser_info &info, element &elem)
{
  info.green = digit10_to_byte(ch);
...
constexpr void parse_fg_high_colour_0(
    char const ch, parser_info &info, element &elem)
{
  info.red = digit10_to_byte(ch);
...
constexpr void parse_fg_low_colour(
    char const ch, parser_info &info, element &elem)
{
  auto const col_code = digit10_to_byte(ch);
  auto const col = static_cast<terminalpp::graphics::colour>(col_code);
...
constexpr void parse_underlining(
    char const ch, parser_info &info, element &elem)
{
  switch (ch)
  {
...
constexpr void parse_charset_ext(
    char const ch, parser_info &info, element &elem)
{
...
constexpr element element_with_base(element const &elem_base)
{
  ...
  result.glyph_.charset_ = result.glyph_.charset_ == charset::utf8
                               ? charset::us_ascii
