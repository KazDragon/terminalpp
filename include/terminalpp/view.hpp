...
public :
    ...
    //* =====================================================================
    void draw(view_context &vc, rectangle const &region)
    {
        self_->draw(vc, region);
    }
    ...
    //* =====================================================================
    boost::any event(view_context &vc, boost::any const &ev)
    {
        return self_->event(vc, ev);
    }
...
private :
    ...
    {
        virtual ~concept(){}
        virtual void draw(view_context &vc, rectangle const &region) const = 0;
        virtual extent get_preferred_size() const = 0;
        virtual void set_size(extent const &size) = 0;
        virtual extent get_size() const = 0;
        virtual boost::any event(view_context &vc, boost::any const &ev) = 0;
    };
    ...
    struct model : concept
    {
        ...
        void draw(view_context &vc, rectangle const &region) const override
        {
            mdl_.draw(vc, region);
        }
        ...
        boost::any event(view_context &vc, boost::any const &ev) override
        {
            return mdl_.event(vc, ev);
        }
