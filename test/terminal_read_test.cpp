...
static token_test_data const token_test_data_table[] = {
 ...
 // Single characters yield virtual keys
    token_test_data{
            ...
            {'z'_tb}}}                                                                 },
    token_test_data{
                    "a"_tb,           {terminalpp::virtual_key{
            terminalpp::vk::lowercase_a,
            terminalpp::vk_modifier::none,
            1,
            {'a'_tb}}}                                                                 },
    token_test_data{
                    "J"_tb,           {terminalpp::virtual_key{
            terminalpp::vk::uppercase_j,
            terminalpp::vk_modifier::none,
            1,
            {'J'_tb}}}                                                                 },
    token_test_data{
                    "X"_tb,           {terminalpp::virtual_key{
            terminalpp::vk::uppercase_x,
            terminalpp::vk_modifier::none,
            1,
            {'X'_tb}}}                                                                 },
 ...
 // Protocol-encoded commands are converted to control sequences
    ...
    token_test_data{
                    "\x9BS"_tb,       {terminalpp::control_sequence{'[', 'S', false, {""_tb}}}                    },
    token_test_data{
                    "\x1B[22;33S"_tb, {terminalpp::control_sequence{'[', 'S', false, {"22"_tb, "33"_tb}}}         },
    token_test_data{
                    "\x9B"_tb
        "22;33S"_tb,                  {terminalpp::control_sequence{'[', 'S', false, {"22"_tb, "33"_tb}}}         },
    token_test_data{
 ...
 // Extended commands are converted to extended control sequences
    ...
    token_test_data{
                    "\x1B[>5c"_tb,    {terminalpp::control_sequence{'[', 'c', false, {"5"_tb}, '>'}}              },
    token_test_data{
                    "\x1B[!p"_tb,     {terminalpp::control_sequence{'[', 'p', false, {""_tb}, '!'}}               },
    token_test_data{
 ...
 // ANSI mouse events are converted to the respective structure
    ...
    token_test_data{
            ...
            terminalpp::mouse::event_type::left_button_down, {31, 33}}}        },
    token_test_data{
 ...
 // Cursor keys are converted to the respective virtual keys.
    ...
    token_test_data{
                    "\x1B[1A"_tb,     {terminalpp::virtual_key{
            terminalpp::vk::cursor_up,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', 'A', false, {"1"_tb}}}}            },
    token_test_data{
                    "\x1B[2A"_tb,     {terminalpp::virtual_key{
            terminalpp::vk::cursor_up,
            terminalpp::vk_modifier::none,
            2,
            terminalpp::control_sequence{'[', 'A', false, {"2"_tb}}}}            },
    token_test_data{
                    "\x1B[3A"_tb,     {terminalpp::virtual_key{
            terminalpp::vk::cursor_up,
            terminalpp::vk_modifier::none,
            3,
    ...
    token_test_data{
                    "\x1B\x1B[A"_tb,  {terminalpp::virtual_key{
            terminalpp::vk::cursor_up,
 ...
 // Keypad commands can have modifiers
    ...
    token_test_data{
                    "\x1B\x1B[6~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::pgdn,
            terminalpp::vk_modifier::meta,
            1,
 ...
 // All forms of tab key should yield the same virtual key
    ...
    token_test_data{
                    "\x1B[I"_tb,      {terminalpp::virtual_key{
            terminalpp::vk::ht,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', 'I', false, {""_tb}}}}              },
    token_test_data{
                    "\x1B[7I"_tb,     {terminalpp::virtual_key{
            terminalpp::vk::ht,
            terminalpp::vk_modifier::none,
            7,
            terminalpp::control_sequence{'[', 'I', false, {"7"_tb}}}}            },
    token_test_data{
                    "\x9BI"_tb,       {terminalpp::virtual_key{
            terminalpp::vk::ht,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', 'I', false, {""_tb}}}}               },
    token_test_data{
                    "\x1BOI"_tb,      {terminalpp::virtual_key{
            terminalpp::vk::ht,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'O', 'I', false, {""_tb}}}}              },
    token_test_data{
                    "\x8FI"_tb,       {terminalpp::virtual_key{
            terminalpp::vk::ht,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'O', 'I', false, {""_tb}}}}               },
    ...
    token_test_data{
                    "\x1B[Z"_tb,      {terminalpp::virtual_key{
            terminalpp::vk::bt,
            terminalpp::vk_modifier::none,
            1,
 ...
 // Including this common but incorrect form.
    token_test_data{
            ...
            terminalpp::vk::enter, terminalpp::vk_modifier::none, 1, '\n'_tb}}      },
    token_test_data{
                    "\r\0"_tb,        {terminalpp::virtual_key{
            terminalpp::vk::enter, terminalpp::vk_modifier::none, 1, '\n'_tb}}      },
    token_test_data{
                    "\r\0\r\0"_tb,    {
            terminalpp::virtual_key{
    ...
    token_test_data{
                    "\x1BOM"_tb,      {terminalpp::virtual_key{
            terminalpp::vk::enter,
            terminalpp::vk_modifier::none,
            1,
 ...
 // Function keys are converted to the respective virtual keys
    ...
    token_test_data{
                    "\x1B[12~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f2,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', '~', false, {"12"_tb}}}}          },
    token_test_data{
                    "\x1B[13~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f3,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', '~', false, {"13"_tb}}}}          },
    token_test_data{
                    "\x1B[14~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f4,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', '~', false, {"14"_tb}}}}          },
    token_test_data{
                    "\x1B[15~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f5,
            terminalpp::vk_modifier::none,
            1,
 ...
 // Sic.  The protocol really skips over 16~ and goes to 17~ for f6.
    ...
    token_test_data{
                    "\x1B[18~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f7,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', '~', false, {"18"_tb}}}}          },
    token_test_data{
                    "\x1B[19~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f8,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', '~', false, {"19"_tb}}}}          },
    token_test_data{
                    "\x1B[20~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f9,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'[', '~', false, {"20"_tb}}}}          },
    token_test_data{
                    "\x1B[21~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f10,
            terminalpp::vk_modifier::none,
            1,
 ...
 // Sic.  The protocol really skips over 22~ and goes to 23~ for f11.
    ...
    token_test_data{
                    "\x1B[24~"_tb,    {terminalpp::virtual_key{
            terminalpp::vk::f12,
            terminalpp::vk_modifier::none,
            1,
 ...
 // Function keys may have modifiers
    ...
    token_test_data{
                    "\x1B[24;9~"_tb,  {terminalpp::virtual_key{
            terminalpp::vk::f12,
            terminalpp::vk_modifier::meta,
            1,
            terminalpp::control_sequence{'[', '~', false, {"24"_tb, "9"_tb}}}}},
    token_test_data{
                    "\x1B[24;10~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::f12,
            terminalpp::vk_modifier::meta | terminalpp::vk_modifier::shift,
            1,
            terminalpp::control_sequence{
                '[', '~', false, {"24"_tb, "10"_tb}}}}                       },
    token_test_data{
                    "\x1B[24;11~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::f12,
            ...
            terminalpp::control_sequence{
                '[', '~', false, {"24"_tb, "11"_tb}}}}                       },
    token_test_data{
                    "\x1B[24;12~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::f12,
            terminalpp::vk_modifier::meta | terminalpp::vk_modifier::shift
                | terminalpp::vk_modifier::alt,
            1,
            terminalpp::control_sequence{
                '[', '~', false, {"24"_tb, "12"_tb}}}}                       },
    token_test_data{
                    "\x1B[24;13~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::f12,
            ...
            terminalpp::control_sequence{
                '[', '~', false, {"24"_tb, "13"_tb}}}}                       },
    token_test_data{
                    "\x1B[24;14~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::f12,
            terminalpp::vk_modifier::meta | terminalpp::vk_modifier::shift
                | terminalpp::vk_modifier::ctrl,
            1,
            terminalpp::control_sequence{
                '[', '~', false, {"24"_tb, "14"_tb}}}}                       },
    token_test_data{
                    "\x1B[24;15~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::f12,
            terminalpp::vk_modifier::meta | terminalpp::vk_modifier::ctrl
                | terminalpp::vk_modifier::alt,
            1,
            terminalpp::control_sequence{
                '[', '~', false, {"24"_tb, "15"_tb}}}}                       },
    token_test_data{
                    "\x1B[24;16~"_tb, {terminalpp::virtual_key{
            terminalpp::vk::f12,
            terminalpp::vk_modifier::meta | terminalpp::vk_modifier::shift
 ...
 // We can also parse alternative SS3 fkey sequences
    ...
    token_test_data{
                    "\x1BOQ"_tb,      {terminalpp::virtual_key{
            terminalpp::vk::f2,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'O', 'Q', false, {""_tb}}}}              },
    token_test_data{
                    "\x1BOR"_tb,      {terminalpp::virtual_key{
            terminalpp::vk::f3,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'O', 'R', false, {""_tb}}}}              },
    token_test_data{
                    "\x1BOS"_tb,      {terminalpp::virtual_key{
            terminalpp::vk::f4,
            terminalpp::vk_modifier::none,
            1,
            terminalpp::control_sequence{'O', 'S', false, {""_tb}}}}              },
    token_test_data{
                    "\x1B\x1BOS"_tb,  {terminalpp::virtual_key{
            terminalpp::vk::f4,
            terminalpp::vk_modifier::meta,
            1,
...
static partial_token_test_data const partial_token_test_data_table[] = {
    partial_token_test_data{
                            "\x1B"_tb,   "[X"_tb,
                            {terminalpp::control_sequence{'[', 'X', false, {""_tb}}}},
    partial_token_test_data{
                            "\x9B"_tb,   "X"_tb,
                            {terminalpp::control_sequence{'[', 'X', false, {""_tb}}}},
    partial_token_test_data{
