...
TEST_P(a_terminal_reading_input_tokens, tokenizes_the_results)
{
  ...
  terminal_.async_read(
      [&result](terminalpp::tokens tokens)
...
static token_test_data const token_test_data_table[] = {
    ...
    token_test_data{
        "\x1B[22;33S"_tb,
        {terminalpp::control_sequence{'[', 'S', false, {"22"_tb, "33"_tb}}}},
    token_test_data{
        "\x9B"_tb
        "22;33S"_tb,
        {terminalpp::control_sequence{'[', 'S', false, {"22"_tb, "33"_tb}}}},
    ...
    token_test_data{
        "\x1B\x1B[S"_tb,
        {terminalpp::control_sequence{'[', 'S', true, {""_tb}}}},
    token_test_data{
        "\x1B\x1B[T"_tb,
        {terminalpp::control_sequence{'[', 'T', true, {""_tb}}}},

    // Extended commands are converted to extended control sequences
    token_test_data{
        "\x1B[?6n"_tb,
        {terminalpp::control_sequence{'[', 'n', false, {"6"_tb}, '?'}}},
    token_test_data{
        "\x1B[>5c"_tb,
        {terminalpp::control_sequence{'[', 'c', false, {"5"_tb}, '>'}}},
    token_test_data{
        "\x1B[!p"_tb,
        {terminalpp::control_sequence{'[', 'p', false, {""_tb}, '!'}}},
    token_test_data{
        "\x9B!p"_tb,
        {terminalpp::control_sequence{'[', 'p', false, {""_tb}, '!'}}},
