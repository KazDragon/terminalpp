...
static udl_element const udl_elements[] = {
    ...
    udl_element{
        R"(\c%5j)"_ete,
        with_charset({'j'}, terminalpp::charset::dec_supplementary_graphics)},

    // Extras after the code take precedence
    udl_element{
        R"(\c0\c%5d)"_ete,
        with_charset({'d'}, terminalpp::charset::dec_supplementary_graphics)},

    // Unknown character sets are ignored.
    udl_element{
        R"(\c%6\c?x)"_ete,
        with_charset({'x'}, terminalpp::charset::portuguese)},
    udl_element{
        R"(\c%6\c%?y)"_ete,
        with_charset({'y'}, terminalpp::charset::portuguese)},

    // Intensity
    udl_element{
        R"(\i>a)"_ete,
        with_intensity({'a'}, terminalpp::graphics::intensity::bold)},
    udl_element{
        R"(\i<a)"_ete,
        with_intensity({'a'}, terminalpp::graphics::intensity::faint)},
    udl_element{
        R"(\i=a)"_ete,
        with_intensity({'a'}, terminalpp::graphics::intensity::normal)},
    udl_element{
        R"(\ixa)"_ete,
        with_intensity({'a'}, terminalpp::graphics::intensity::normal)},
    ...
    udl_element{
        R"(\p+a)"_ete,
        with_polarity({'a'}, terminalpp::graphics::polarity::positive)},
    udl_element{
        R"(\p-a)"_ete,
        with_polarity({'a'}, terminalpp::graphics::polarity::negative)},
    udl_element{
        R"(\pxa)"_ete,
        with_polarity({'a'}, terminalpp::graphics::polarity::positive)},
    ...
    udl_element{
        R"(\u+a)"_ete,
        with_underlining({'a'}, terminalpp::graphics::underlining::underlined)},
    udl_element{
        R"(\u-a)"_ete,
        with_underlining(
    ...
    udl_element{
        R"(\[2a)"_ete,
        with_foreground_colour({'a'}, terminalpp::palette::green)},
    udl_element{
        R"(\[3a)"_ete,
        with_foreground_colour({'a'}, terminalpp::palette::olive)},
    ...
    udl_element{
        R"(\<000a)"_ete,
        with_foreground_colour({'a'}, terminalpp::high_colour{0, 0, 0})},
    udl_element{
        R"(\<850a)"_ete,
        with_foreground_colour({'a'}, terminalpp::high_colour{8, 5, 0})},
    udl_element{
        R"(\<085a)"_ete,
        with_foreground_colour({'a'}, terminalpp::high_colour{0, 8, 5})},
    ...
    udl_element{
        R"(\{00a)"_ete,
        with_foreground_colour({'a'}, terminalpp::greyscale_colour{0})},
    udl_element{
        R"(\{17a)"_ete,
        with_foreground_colour({'a'}, terminalpp::greyscale_colour{17})},
    udl_element{
        R"(\{22a)"_ete,
        with_foreground_colour({'a'}, terminalpp::greyscale_colour{22})},
    ...
    udl_element{
        R"(\(000000a)"_ete,
        with_foreground_colour({'a'}, terminalpp::true_colour{0, 0, 0})},
    udl_element{
        R"(\(A917BEa)"_ete,
        with_foreground_colour(
    ...
    udl_element{
        R"(\]2a)"_ete,
        with_background_colour({'a'}, terminalpp::palette::green)},
    udl_element{
        R"(\]3a)"_ete,
        with_background_colour({'a'}, terminalpp::palette::olive)},
    ...
    udl_element{
        R"(\>000a)"_ete,
        with_background_colour({'a'}, terminalpp::high_colour{0, 0, 0})},
    udl_element{
        R"(\>850a)"_ete,
        with_background_colour({'a'}, terminalpp::high_colour{8, 5, 0})},
    udl_element{
        R"(\>085a)"_ete,
        with_background_colour({'a'}, terminalpp::high_colour{0, 8, 5})},
    ...
    udl_element{
        R"(\}00a)"_ete,
        with_background_colour({'a'}, terminalpp::greyscale_colour{0})},
    udl_element{
        R"(\}17a)"_ete,
        with_background_colour({'a'}, terminalpp::greyscale_colour{17})},
    udl_element{
        R"(\}22a)"_ete,
        with_background_colour({'a'}, terminalpp::greyscale_colour{22})},
    ...
    udl_element{
        R"(\)000000a)"_ete,
        with_background_colour({'a'}, terminalpp::true_colour{0, 0, 0})},
    udl_element{
        R"(\)A917BEa)"_ete,
        with_background_colour(
            {'a'}, terminalpp::true_colour{0xA9, 0x17, 0xBE})},
    ...
    udl_element{
        R"(\U0057)"_ete, terminalpp::element{terminalpp::glyph{"\x57"}}},
    udl_element{
        R"(\U16B8)"_ete,
        terminalpp::element{terminalpp::glyph{"\xE1\x9A\xB8"}}},
    ...
    udl_element{
        R"(\U010E\C097)"_ete,
        terminalpp::element{terminalpp::glyph{"\xC4\x8E"}}},
    udl_element{
        R"(\U010E\U16B8)"_ete,
        terminalpp::element{terminalpp::glyph{"\xC4\x8E"}}},
