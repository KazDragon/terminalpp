...
static virtual_key_test_data const virtual_key_strings[] = {
    ...
    virtual_key_test_data{
        ...
        "virtual_key[vk:'?']"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::uppercase_m},
        "virtual_key[vk:'M']"},
    virtual_key_test_data{
    ...
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::cr}, "virtual_key[vk:'\\r']"},
    virtual_key_test_data{
    ...
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::cursor_left},
        "virtual_key[vk:cursor_left]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::cursor_right},
        "virtual_key[vk:cursor_right]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::home}, "virtual_key[vk:home]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::end}, "virtual_key[vk:end]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::ins}, "virtual_key[vk:ins]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::end}, "virtual_key[vk:end]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::pgup}, "virtual_key[vk:pgup]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::pgdn}, "virtual_key[vk:pgdn]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::bt}, "virtual_key[vk:bt]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::enter},
        "virtual_key[vk:enter]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f1}, "virtual_key[vk:f1]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f2}, "virtual_key[vk:f2]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f3}, "virtual_key[vk:f3]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f4}, "virtual_key[vk:f4]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f5}, "virtual_key[vk:f5]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f6}, "virtual_key[vk:f6]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f7}, "virtual_key[vk:f7]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f8}, "virtual_key[vk:f8]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f9}, "virtual_key[vk:f9]"},
    virtual_key_test_data{
        terminalpp::virtual_key{terminalpp::vk::f10}, "virtual_key[vk:f10]"},
    virtual_key_test_data{
    ...
    virtual_key_test_data{
        ...
        "virtual_key[shift]"},
    virtual_key_test_data{
        terminalpp::virtual_key{default_vk.key, terminalpp::vk_modifier::ctrl},
        "virtual_key[ctrl]"},
    virtual_key_test_data{
        terminalpp::virtual_key{default_vk.key, terminalpp::vk_modifier::alt},
        "virtual_key[alt]"},
    virtual_key_test_data{
        terminalpp::virtual_key{default_vk.key, terminalpp::vk_modifier::meta},
        "virtual_key[meta]"},
    ...
    virtual_key_test_data{
        terminalpp::virtual_key{
            ...
            terminalpp::control_sequence{'[', 'H', false, {{"23"_tb}}}},
